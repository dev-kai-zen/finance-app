...
export const DEFAULT_SEED_CATEGORIES: (CategoryInput & { id: string; isSystem: boolean })[] = [
  ...
  {
    id: "cat_sub_food_restaurants",
    name: "Restaurants & Dining Out",
    type: "expense",
    color: "orange",
    icon: "utensils",
    parentId: "cat_exp_food",
    isSystem: false,
  },
  {
    id: "cat_sub_food_coffee",
    name: "Coffee & Cafes",
    type: "expense",
    color: "orange",
    icon: "utensils",
  ...
  {
    id: "cat_sub_transport_fuel",
    name: "Gas & Fuel",
    type: "expense",
    color: "blue",
    icon: "car",
    parentId: "cat_exp_transport",
    isSystem: false,
  },
  {
    id: "cat_sub_transport_transit",
  ...
  {
    id: "cat_sub_util_electric",
    name: "Electricity",
    type: "expense",
    color: "amber",
    icon: "zap",
    parentId: "cat_exp_utilities",
    isSystem: false,
  },
  {
    id: "cat_sub_util_water",
  ...
  {
    id: "cat_sub_shop_clothes",
    name: "Clothing & Apparel",
    type: "expense",
    color: "pink",
    icon: "tag",
    parentId: "cat_exp_shopping",
    isSystem: false,
  },
  {
    id: "cat_sub_shop_tech",
